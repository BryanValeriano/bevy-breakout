...
export function wasm_bindgen__convert__closures__invoke0_mut__h2ab5b12e620c70c6(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0ea099a9e2a73d94(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hf490eb95c6e403fb(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__he9478a80a1fc14d4(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb4aef6e63a89433d(a: number, b: number, c: number): void;
